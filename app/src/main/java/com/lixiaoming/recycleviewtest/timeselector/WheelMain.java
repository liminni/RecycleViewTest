...
public class WheelMain {
    ...
    public WheelMain(View view, boolean hasSelectTime, boolean hasDate) {
        super();
        this.view = view;
        this.hasSelectTime = hasSelectTime;
    ...
    public void initDateTimePicker(int year, int month, int day, int h, int m) {
        ...
        if (hasSelectTime && hasDate) {
            ...
            wv_mins.setAdapter(new MinuteAdapter(0, 59));
    ...
    public String getHoursAndMins(){
        StringBuffer sb = new StringBuffer();
        sb.append(wv_hours.getCurrentItem()).append(":").append(wv_mins.getCurrentItem()*5);
        return sb.toString();
    }
}
