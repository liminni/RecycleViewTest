...
'netWork.services',
'netWork.detailService',
  'netWork.directives',
  'netWork.detailCtrl',
  "netWork.messageCtrl",
  'netWork.detailAnimateCtrl',
  "netWork.filter"
])
.value("CONFIG", {
...
.config(function($stateProvider, $urlRouterProvider,$ionicConfigProvider) {
  ...
  .state("detailAnimate",{
      url:"/detailAnimate",
      templateUrl:'templates/detailAnimate.html',
      controller:'DetailAnimateCtrl'
  })
  .state("message",{
    url:"/message",
...
$urlRouterProvider.otherwise('/detailAnimate');
})
