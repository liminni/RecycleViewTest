console.log("MDHAdapter Ver : 3.5.2, 2013-10-30 13:40:51");
...
//    h.appendChild(c)
	...
	for(var i = 0 ; i < scriptPaths.length ; i++){
		if(!scriptPaths[i].getAttribute("src")){
			return;
		}
		if(scriptPaths[i].getAttribute("src").indexOf('MDHVirtualAdapter.js') !== -1){
			return;
		}
		if(scriptPaths[i].getAttribute("src").indexOf('header.js') !== -1){
			headerPath = scriptPaths[i].getAttribute("src").split('header.js')[0];
			console.info(headerPath);
			var path =  headerPath + rootPath; 
		    
			document.write('<script src="'+ path + '../common/mau/' + f + '"></script>');
		}
	}
}
var MDHValidator = new
function() {
...
if (navigator.userAgent.indexOf("iPhone OS 6_") > 0 || navigator.userAgent.indexOf("iPad; CPU OS 6_") > 0) { (function(g) {
        var a = {};
        var d = {};
        var e = g.setTimeout;
        var f = g.setInterval;
    ...
    this._EventTarget.prototype = {
        ...
        removeListener: function(d, e) {
            if (this._listeners[d] instanceof Array) {
                ...
                if (c.length == 0) {
                    MDHMgr.exec("CustomEvent.unlink",
                    function() {},
                    function() {},
                    {
                        type: d
...
function() {
    ...
    function() {
        ...
        this.watchAcceleration = function(b, c, d) {
            ...
            if (!MDHValidator.isNumber_ge(0, d.frequency)) {
    ...
    function() {
        ...
        this.addListener = function(a, b) {
            ...
            this._listeners[a].push(b);
            MDHMgr.exec("Camera.addListener",
            function() {},
            function() {},
            {
                type: a
        ...
        this.removeListener = function(d, e) {
            ...
            if (this._listeners[d] instanceof Array) {
                ...
                if (c.length == 0) {
                    MDHMgr.exec("Camera.removeListener",
                    function() {},
                    function() {},
                    {
                        type: d
...
function() {
    ...
    function() {
        this.startLoadingBar = function() {
            if (typeof arguments[0] != "function" && arguments.length == 1) {
             ...
             if (agent.indexOf('iphone') > -1 || agent.indexOf('ipad') > -1) {
                 MDHMgr.exec("Loading.start",
                             function() {},
                             function() {},
                             arguments[0])
                 }else
                 {
                 MDHMgr.exec("Browser.startLoadingBar",
                             function() {},
                             function() {},
                             arguments[0])
                 }
                ...
                if (typeof arguments[0] == "function" && typeof arguments[1] != "function" && arguments.length == 2) {
                    MDHMgr.exec("Browser.startLoadingBar", arguments[0],
                    function() {},
                    arguments[1])
                } else {
        ...
        this.stopLoadingBar = function() {
                                                     //李希东修改2014-05-07-19:49:00
             var agent = navigator.userAgent.toLowerCase();
             if (agent.indexOf('iphone') > -1 || agent.indexOf('ipad') > -1) {
             MDHMgr.exec("Loading.stop",
                         function() {},
                         function() {},
                         {})
             }else
             {
             MDHMgr.exec("Browser.stopLoadingBar",
                         function() {},
                         function() {},
                         {})
             }
        ...
        this.clearHistory = function() {
            MDHMgr.exec("Browser.clearHistory",
            function() {},
            function() {},
            {})
        };
        ...
        this.getCurrentOrientation = function(a) {
            MDHMgr.exec("Browser.getCurrentOrientation", a,
            function() {},
            {})
        };
        ...
        this.clearCache = function() {
            MDHMgr.exec("Browser.clearCache",
            function() {},
            function() {},
            {})
        };
        ...
        this.terminateApp = function(a) {
            if (a) {
                MDHMgr.exec("Browser.terminateApp",
                function() {},
                function() {},
                {
                    "with": a
                ...
                MDHMgr.exec("Browser.terminateApp2",
                function() {},
                function() {},
                {})
            }
        ...
        this.setLocation = function(a) {
            if (MDHMgr.device.platform == "iOS") {
                MDHMgr.exec("Browser.setLocation",
                function() {},
                function() {},
                {
                    href: a
    ...
    this._PushTarget.prototype = {
        ...
        removeListener: function(d, e) {
            if (this._listeners[d] instanceof Array) {
                ...
                if (c.length == 0) {
                    MDHMgr.exec("Push.removeListener",
                    function() {},
                    function() {},
                    {
                        type: d
...
if ((typeof MDHBasic === "object") && (typeof MDHBasic.SEMP === "undefined") && (typeof MDHBasic.VPN === "undefined") && (typeof MDHBasic.SEMPLog === "undefined") && (typeof MDHBasic.SEMPProvision == "undefined")) {
    MDHBasic.SEMP = new
    function() {
